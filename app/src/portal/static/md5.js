 ...
 *
 * This is the same algorithm MikroTik's hotspot md5.js uses for HTTP-CHAP login,
 * exposing hexMD5(). Keep it byte-for-byte compatible — the router recomputes the
 * same hash server-side and compares.
 */
var hexcase = 0;
